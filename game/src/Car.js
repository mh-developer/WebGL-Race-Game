...
Car.prototype = {
  create: function () {
    this.gameObject = new GameObject(CAR_OBJ3, "Assets/Models/original/Lamborginhi Aventador_diffuse.jpeg")
    // this.gameObject = new GameObject(CAR_OBJ2, "Assets/Textures/FREE-CAR-Texture.png")
    this.gameObject.initCarBuffers()
    this.gameObject.setScale(0.004, 0.004, 0.004)
  ...
  kill: function () {
    this.gameObject.setPosition(0.0, 0.05, 15)
    this.acceleration = 0
    this.speed = 0
    this.targetSpeed = 0
    this.angle = 270
